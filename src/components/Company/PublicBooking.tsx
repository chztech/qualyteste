...
export default function PublicBooking({
  ...
  const availableSlots = useMemo<AvailableSlot[]>(() => {
    ...
    const companySlots = appointments.filter((apt) => {
      ...
      const isOpenStatus =
        (apt.status as string) === "scheduled" || (apt.status as string) === "confirmed";
    ...
    return companySlots
      .map((apt) => {
        const provider =
          providers.find((p) => p.id === apt.providerId) || null;
        const serviceName =
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-800 text-xs sm:text-sm">
                  Selecione uma das datas abaixo que possuem horários disponíveis
                  para agendamento.
                  <br />
          ...
          {step === 3 && selectedDate && (
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-800 text-xs sm:text-sm">
                  Para a data selecionada ({formatDate(selectedDate)}), escolha o
                  turno de sua preferência ou veja todos os horários.
                </p>
              </div>
              ...
              {selectedSlot && (
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  ...
                  <div className="text-green-800 space-y-1 text-xs sm:text-sm">
                    ...
                    <div>
                      ⏱️ <strong>Duração:</strong> {selectedSlot.duration} minutos
                    </div>
                  </div>
                </div>
              )}
